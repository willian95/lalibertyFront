        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-8">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum itaque magnam culpa, numquam
                  molestiae, molestias eligendi voluptas doloremque vero mollitia esse non dolorum consectetur
                  quisquam voluptatem distinctio sunt pariatur harum. <br><br> Lorem ipsum dolor sit amet consectetur
                  adipisicing elit. Iusto inventore nesciunt sunt, atque enim assumenda aliquid doloribus ullam
                  tempora? Error minus, pariatur cupiditate atque architecto est. Rerum vitae cumque minima.</p>
              </div>
            </div>
        ...
        <div class="row">
                  ...
                  <div class="card-body">
                    <form>
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          <input type="text" class="form-control" placeholder="Carrera 4 # 12 12">
                        </div>
                        <div class="col-md-6 mb-3">
          ...
          <div class="col-md-4">
            <div class="resumen">
              ...
              <ul>
                <li><p><strong>Subtotal:</strong>  $1,998.00</p></li>
                <li><p><strong>Envio:</strong> $5.00</p></li>

                <li class="border-top pt-3"><p><strong>Total:</strong>$2.003.00</p></li>
              </ul>
            </div>
...
<!-- Modal blog detalle -->
<div class="modal fade" id="blog-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header border-0">
       <p class="titulo-producto">Titulo del articulo    -    01/12/20
      </p>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body">
        ...
        <div class="content-blog">
          <img src="http://imgfz.com/i/wJ0E4ti.png" alt="">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut minima eos reiciendis quisquam fugit. Unde aliquid neque ut illum? In optio laboriosam ipsa cupiditate, sapiente dignissimos necessitatibus pariatur blanditiis omnis.

            <br>
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Adipisci sint non, cum obcaecati aliquid labore? Sint nisi adipisci asperiores deleniti, ipsa quos quo quaerat quam? Culpa itaque labore magni illum.
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos ratione error repellat quam, repellendus distinctio minus, est, doloribus labore officia maxime perspiciatis! Ratione autem, velit debitis ullam odio inventore? Quo?
            </p>
          </p>
        </div>
      </div>
