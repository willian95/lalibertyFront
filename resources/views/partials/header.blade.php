  ...
  <nav class='navbar navbar-expand-md navbar-fixed-js'>
    ...
    <div class='offcanvas-collapse fil' id='navbarNav'>
      <ul class='navbar-nav '>
          ...
          <div class="col-md-12 flex-custom  mt-3">
            ...
            <div class="redes-nav">
              <li class='nav-item mr-2'>
                <a class='redes' href='#'>
                  <svg class="color-search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g data-name="Layer 2">
                      <g data-name="search">
        ...
        <div class="col-md-12  espacios-m6 m7">
          <div class="menu-flex">
    ...
    <div class="modal fade terminos" id="terminos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
