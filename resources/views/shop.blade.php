        ...
        <nav class='navbar navbar-expand-md navbar-fixed-js'>
          <div class='flex-custom'>
            <a class='brand brand-xs' href='#'>
              <img class="invertir-color" alt='' src='assets/img/logo.png'>
            </a>
              ...
              <ul class='navbar-nav'>
                <div class="row">
                  ...
                  <div class="col-md-12  espacios-m6">
                    ...
                    <div class="col-md-12">
                      <p class="txt nav-link-white">We are a brand the loves to work with other brands</p>
                    </div>
                  </div>
